 ...
 */
final class Version20210411130337 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE regime (id_regime INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, duration INT NOT NULL, id_User INT DEFAULT NULL, INDEX id_User (id_User), PRIMARY KEY(id_regime)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE regime ADD CONSTRAINT FK_AA864A7CA6816575 FOREIGN KEY (id_User) REFERENCES user (id)');
